...
const CommentContainer = (props) => {
 ...
 return (
 	...
 	{props.comments.length > 0 ? <h2 className="review-title">Reviews for {props.currentsite.name}</h2> : <h2 className='no-comment'>Sorry, there are no reviews for {props.currentsite.name} yet.</h2>}
