...
const SurfaceWeather = (props) => {
	return (
		<div className='col-md-12 weather-section'>
			<img src={props.weatherdata.current_observation.icon_url} /><span className='forecast'>{props.weatherdata.current_observation.icon}</span><span className='temp data'>{props.weatherdata.current_observation.temp_f}&#176;</span>
			<table className="table">
			  <tbody>
				  ...
				  <tr><td>Dew Point: <span className='data'>{props.weatherdata.current_observation.dewpoint_f}</span></td><td>Humidity: <span className='data'>{props.weatherdata.current_observation.relative_humidity}</span></td></tr>
				  ...
				  <tr><td>Weather Provided by:<a href={props.weatherdata.current_observation.image.link}><img width='50px' src={props.weatherdata.current_observation.image.url} /></a></td><td></td></tr>
			  </tbody>
				</table>
		</div>
	);
